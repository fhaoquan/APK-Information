...
//  $images = json_decode(@file_get_contents($json_filename), true)['images'];
//  foreach ($images as $image) {
//    $image_filename = './resources/' . $file . "_" . $image['width'] . 'x' . $image['height'] . '.' . mb_strtolower(mbereg_replace('image/', '', $image['mime_type']));
...
<div data-role="page" id="pageone">
  ...
  <div data-role="main" class="ui-content"><br><br>
    ...
    <ul data-role="listview" data-filter="true" data-input="#myFilter" data-autodividers="true" data-inset="true">
      <li><a data-ajax="false" href="http://apk.eladkarako.com/<?php echo ""/*$filenamePath;*/
        ; ?>"><?php echo ""/* $filename; */
          ; ?></a></li>
    </ul>
    <br>
...
<!--       return li.attr('data-letter').toLowerCase();-->
<!--     }-->
<!--   })-->
<!--   .listview('refresh');-->
<!---->
